...
public class Left extends Resolution{
	...
	public List<int[]> searchNeighborLeft(int[] position, MazeGenerator maze, String direction) {
        ...
        switch (direction) {
            case "N":
                // gauche (W), devant (N), droite (E), derrière (S)
                // ordre inversé → S, E, N, W
                directions = new int[][]{{1, 0}, {0, 1}, {-1, 0}, {0, -1}};
                break;
            case "E":
            	// gauche (N), devant (E), droite (S), derrière (W)
            	//inverse
            	directions = new int[][]{{0, -1}, {1, 0}, {0, 1}, {-1, 0}};
                break;
            case "S":
            	// gauche (E), devant (S), droite (W), derrière (N)
            	//inverse
            	directions = new int[][]{{-1, 0}, {0, -1}, {1, 0}, {0, 1}};
                break;
            case "W":
            	// gauche (S), devant (W), droite (N), derrière (E)
            	//inverse
            	directions = new int[][]{{0, 1}, {-1, 0}, {0, -1}, {1, 0}};
                break;
            default:
